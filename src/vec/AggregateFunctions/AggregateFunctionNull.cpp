...
#include <vec/AggregateFunctions/AggregateFunctionNothing.h>
#include <vec/AggregateFunctions/AggregateFunctionCount.h>
#include <vec/AggregateFunctions/IAggregateFunction.h>
#include <vec/AggregateFunctions/IAggregateFunctionCombinator.h>
...
void registerAggregateFunctionCombinatorNull(AggregateFunctionSimpleFactory & factory)
{
    ...
    AggregateFunctionCreator creator = [&](const std::string& name, const DataTypes& types, const Array& params) {
